  ...
  return (
    <div className="flex min-h-svh flex-col overflow-x-clip">
        ...
        <div className="w-full px-4 sm:px-5">
          <div className="flex h-[60px] items-center gap-3">
            ...
            <div className="ml-auto flex items-center gap-2">
              {/* Ay kutucukları — yalnız yönetici; personel hep tümünü görür */}
      ...
      <Link
        ...
        className="fixed inset-x-0 z-40 mx-auto flex h-[68px] w-[68px] items-center justify-center rounded-full bg-primary text-primary-foreground shadow-[0_12px_28px_-6px_rgba(30,64,175,.6)] transition-transform active:scale-95 sm:hidden"
